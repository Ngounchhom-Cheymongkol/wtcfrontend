                        ...
                        <div class="flex md:order-2">
                                ...
                                <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-4">
                                        <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                                                ...
                                                <li>
                                                <a href="#" class={"block py-2 pr-4 pl-3 text-white text-base md:bg-transparent md:text-black md:p-0 dark:text-white rounded-none hover:border-b-cyan-500"+
                                                        (openTab === 2
                                                        ? "text-black border-b-2 border-b-cyan-900"
                                                ...
                                                <a href="#" class={"block py-2 pr-4 pl-3 text-white text-base md:bg-transparent md:text-black md:p-0 dark:text-white rounded-none hover:border-b-cyan-500"+
                                                        (openTab === 4
                                                        ? "text-black border-b-2 border-b-cyan-900"
                                                        : "text-black-600 bg-white")}>Contact</a>
                                                </li>
                                        </ul>
                                </div>
                        </div>
