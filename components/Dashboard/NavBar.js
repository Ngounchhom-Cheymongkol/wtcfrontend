...
//     }
        if(!auth){
                        ...
                        <div class="flex md:order-2">
                                <button onClick={()=>{
                                        router.push('/')
                                }} href='/register'type="button" class="text-white bg-cyan-700 hover:bg-cyan-700 ring-1 ring-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-cyan-900 dark:hover:bg-cyan-700 dark:focus:ring-blue-800 mx-5">Home</button>
